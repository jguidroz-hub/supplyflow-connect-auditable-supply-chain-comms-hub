  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">SupplyFlow Connect - Auditable supply chain comms hub</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Replaces informal messaging (WhatsApp) for supply chain teams, providing a centralized, auditable platform for orders, dispatches, vendor comms, and approvals, ensuring traceability and compliance for logistics managers and procurement teams.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust SupplyFlow Connect - Auditable supply chain comms hub.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} SupplyFlow Connect - Auditable supply chain comms hub. All rights reserved.</p>
