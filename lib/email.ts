...
const FROM = process.env.EMAIL_FROM || 'SupplyFlow Connect - Auditable supply chain comms hub <noreply@example.com>';
const APP_NAME = 'SupplyFlow Connect - Auditable supply chain comms hub';
